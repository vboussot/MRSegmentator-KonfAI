...
def main():
    parser = argparse.ArgumentParser(
        description="MRSegmentator-KonfAI", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
    ...
    parser.add_argument("--version", action="version", version=importlib.metadata.version("mrsegmentator-konfai"))
    ...
    with tempfile.TemporaryDirectory() as tmpdir_str:
        ...
        pred = tmpdir / "Predictions" / "MRSegmentator" / "Dataset" / "P001" / "Seg.mha"
        if not pred.exists():
